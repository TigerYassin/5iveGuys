...
;this is the hardcoded version of a counterclockwise turn
...
BeginTurn:	
    ...
    OUT LVELCMD 
	SEI &B0001
	LOAD &B00000011 ;only enable sonars 0 and 1   
	OUT SONAREN  
    LOADI 150 ;load the alarm distance
	OUT SONALARM
	LOAD &B00000011 
	OUT SONARINT
    JUMP CheckSonars
...
CheckSonars: 
    ;if the sonalarm register is within the trigger distance then slow down the right wheel
	;speed until you are not within the trigger distance 
	IN SONALARM 
	OUT SSEG1
	IN SONALARM 
	AND Mask0
	JPOS SlowRightWheel ;the sonalarm has triggered
	JZERO FastRightWheel
