...
Main:
	...
	SEI  &B0001
CheckFront:
    SONAREN  &B00111111 ; this will enable sonars 0 through 5
    ...
    LOAD Ft1 ;load the mm value for one foot into the accumulator
    OUT SONALARM
...
StopAndTurn:
   ...
   ; STORE  AlarmTrigger ;save the sonar that triggered the alarmm ;does the jump instruction change the accumulator
	...
	LOAD  AlarmTrigger
	AND  Mask0
	JPOS Die ;no need to turn if already normal to it 
	LOAD AlarmTrigger
	...
	LOAD AlarmTrigger
	AND  Mask5
	JPOS Die ;but make it a box or a circle
	;LOAD AlarmTrigger
	;AND  Mask
	;JPOS TURN44Left
...
Turn46Left:
	...
	STORE DTheta
	STORE DesiredTheta
	JUMP  Die ;instead of jumping to die i need to check if Dtheta abd theta have matched 
Turn78Left:
    LOAD Deg78
	STORE DTheta
	STORE DesiredTheta
