...
WallReflDetect: 
	...
	OUT		SSEG1
	ADDI 	-870			; add a conservative distance of 3 feet
...
TurnLeft:
	...
	LOAD TurnCount 
	ADDI -18 ;changed to make the number of turns less 
...
CircleCompleted:
    ...
    LOAD CircleCount
    ADDI -2
    JPOS ReadSonars ;if JPOS then i will just continue circling I NEED TO FIGURE OUT WHAT THIS DOES I changed this on 11/11
;----HERE IS WHERE I WILL ADD IN CODE FOR THE PLAN B SLIDE SWITCHES
    IN SWITCHES
    JPOS ReadSonars ;see if any of the slide switches our active then keep circling	
	OUT RESETPOS
	LOADI -90 ;turn 90 degrees so i can enter my exploring subroutine 
	STORE DTheta ;if this code works then the robot will 
	JUMP GoBackToWall ; go back to wall subroutine  will exist in thew explore and circle.asm 
GoBackToWall:
    LOAD Fslow
	STORE DVel
