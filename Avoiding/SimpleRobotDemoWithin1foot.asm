...
CheckFront:
    SONAREN  &B00111111 ; this will enable sonars 0 through 5
						...
						;but SONARINT 00100010 will only let sonars 5 and 1 cause interupts
	...
	OUT SONALARM ;sets the alarm distance to one foot
	IN  SONALARM
    ...
    JUMP  CheckFront ;if not keep checking front
StopAndTurn:
    STORE  AlarmTrigger ;save the sonar that triggered the alarm
