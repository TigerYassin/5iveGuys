...
StartMoving:
	 ...
	 SEI &B0001
	 LOADI &B00000001 ;only enable sonars 5 and 6 
	 OUT SONAREN  
...
ShouldITurn:
	...
	IN SONALARM 
	AND Mask0 ;see if sonar 6 triggered the sonar
	JPOS ShouldITurn ;if sonar 0 is reading then keep turning 
	JUMP TurnLeft45 ;sonar 0 is not there so turn the robot back left 
TurnLeft45:
    LOAD TurnCount
	ADDI 1
	STORE TurnCount
